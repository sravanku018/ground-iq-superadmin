...
export default function AdminProfileScreen({ user, onToast, onUserUpdated }) {
  ...
  const POWERS = [
    ...
    { key: 'can_web_survey', label: 'Web Survey Submissions', desc: 'Create web survey links, fill online & confirm web records', active: isSuper || user?.role === 'admin' || !!user?.can_web_survey },
